...
const App = () => {
    ...
    const generateContent = useCallback(async (itemsToGenerate: ContentItem[]) => {
        ...
        for (const item of itemsToGenerate) {
            ...
            try {
                ...
                // Add References section using top SERP results
                if (serpData && serpData.length > 0) {
                    const topLinks = serpData.slice(0, 5);
                    ...
                    topLinks.forEach(result => {
                        referencesHtml += `<li><a href="${result.link}" target="_blank" rel="noopener noreferrer">${result.title}</a></li>\n`;
                    });
                    referencesHtml += '</ul>';
        ...
        setIsGenerating(false);
    }, [apiClients, selectedModel, apiKeys.serperApiKey, existingPages, wpConfig, siteInfo, callAI, geoTargeting]);
    ...
    const handleSaveChanges = (itemId: string, updatedSeo: { title: string; metaDescription: string; slug: string }, updatedContent: string) => {
        ...
        dispatch({ type: 'SET_ITEMS', payload: newItemsState });
                    ...
                    {activeView === 'setup' && (
                        <div className="setup-view">
                            ...
                            <div className="setup-grid">
                                ...
                                <div className="setup-card full-width">
                                    <h3>Site Information (for Schema Markup)</h3>
                                            ...
                                            <div className="content-hub-table-container">
                                                <div className="table-controls">
                                                    ...
                                                    <div className="hub-actions">
                                                        ...
                                                        >
                                                            Add to Rewrite Queue ({analyzableForRewrite})
                                                        </button>
                                                        <button 
                                                            className="btn" 
